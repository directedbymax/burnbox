...
class MainWindow(QtWidgets.QMainWindow):
    """
    MainWindow is the BurnBox main window, which contains the GUI elements, including all open tabs
    """
    ...
    def tor_connection_canceled(self):
        ...
        def ask():
            ...
            if a.clickedButton() == quit_button:
                # Quit
                self.common.log(
                    "BurnBoxGui", "_tor_connection_canceled", "Quit button clicked"
                )
    ...
    def event(self, event):
        # Check if color mode switched while burnbox was open, if so, ask user to restart
