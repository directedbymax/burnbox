...
from burnbox_cli.common import AutoStopTimer
...
class Mode(QtWidgets.QWidget):
    ...
    def start_server(self):
        """
        Start the burnbox server. This uses multiple threads to start the Tor onion
    ...
    def start_server_step2(self):
        """
        Step 2 in starting the burnbox server.
        """
    ...
    def start_server_step3(self):
        """
        Step 3 in starting the burnbox server.
        """
    ...
    def cancel_server(self):
        ...
        # https://github.com/directedbymax/burnbox/issues/1371
