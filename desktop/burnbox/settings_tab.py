...
class SettingsTab(QtWidgets.QWidget):
    ...
    def __init__(self, common, tab_id, parent=None):
        ...
        # Populate the dropdown with all of BurnBox's available languages
    ...
    def save_clicked(self):
        ...
        if settings:
            # If language changed, inform user they need to restart BurnBox
            ...
            # If color mode changed, inform user they need to restart BurnBox
    ...
    @staticmethod
    def open_help():
        help_url = "https://docs.burnbox.hideaway.chat/"
