...
class Settings(object):
    """
    This class stores all of the settings for BurnBox, specifically for how
    ...
    def __init__(self, common, config=False):
        ...
        # Dictionary of available languages in this version of BurnBox,
    ...
    def build_filename(self):
        ...
        """
        return os.path.join(self.common.build_data_dir(), "burnbox.json")
