...
class BurnBox(object):
    """
    BurnBox is the main application class. Pass in options and run
    ...
    def __init__(self, common, onion, local_only=False, autostop_timer=0):
        ...
        self.common.log("BurnBox", "__init__")
    ...
    def choose_port(self):
        ...
        """
        try:
            self.port = self.common.get_available_port(17600, 17650, max_attempts=200)
        except Exception:
            # Fallback to any OS-assigned port if the preferred range is busy.
    ...
    def start_onion_service(self, mode, mode_settings, await_publication=True):
        """
        Start the burnbox onion service.
        """
        self.common.log("BurnBox", "start_onion_service")
