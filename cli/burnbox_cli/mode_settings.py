...
class ModeSettings:
    """
    This stores the settings for a single instance of an BurnBox mode. In CLI there
    ...
    def build_default_receive_data_dir(self):
        ...
        if self.common.platform == "Darwin":
            ...
            return os.path.join(real_homedir, "BurnBox")
            ...
            return os.path.expanduser("~\\BurnBox")
        else:
            # All other OSes
            return os.path.expanduser("~/BurnBox")
